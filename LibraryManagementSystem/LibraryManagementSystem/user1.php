...
?>
    <h1>Welcome back to AU digital Library!!</h1>
...
$rec="INSERT INTO `cwh_database`.`user1` SELECT * FROM `cwh_database`.`admin_add` WHERE `book_id`='$bid';";
...
$in="INSERT INTO `cwh_database`.`user1` (`book_id`, `book_name`, `author`, `no_of_pages`, `category`) VALUES ('$book_id', '$book_name', '$author', '$no_of_pages','$category');";
$inres=$con->query($in);*/
?>
<table border="1">
<tr>
...
<?php
$tot="SELECT * FROM `cwh_database`.`user1`;";
